...
public:
	...
	void DemoScene(std::vector<PolygonShape>& polygons, ConstraintManager& constraint_mgr, JointPairManager& joint_mgr, uint32_t& id_count) {
		...
		AddPolygon(10, { 551.0f, 115.0f }, olc::MAGENTA, {
			{ 573.627, 137.627 },
			{ 556.006, 146.606 },
			{ 536.472, 143.512 },
			{ 522.488, 129.528 },
		...
		AddPolygon(10, { 417.0f, 56.0f }, olc::BLUE, {
			{ 439.627, 78.6274 },
			{ 422.006, 87.606 },
			{ 402.472, 84.5122 },
			{ 388.488, 70.5277 },
		...
		constraint_mgr.constraints_data.push_back({ 8, { { 551.0f, 115.0f }, { 287.0f, 62.0f } }, 0.5f, 0.2f });
		joint_mgr.data.push_back({ { 8, 9 }, { { 551.0f,115.0f }, { 417.0f,56.0f } }, 0.5f, 0.2f });
	}
};